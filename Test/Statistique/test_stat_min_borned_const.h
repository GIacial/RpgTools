#ifndef TEST_STAT_MIN_BORNED_CONST_H
#define TEST_STAT_MIN_BORNED_CONST_H

#include <QObject>
#include <QtTest/QtTest>

class Test_stat_min_borned_const : public QObject
{
    Q_OBJECT
public:
    explicit Test_stat_min_borned_const();
    ~Test_stat_min_borned_const() throw ();
...
#endif // TEST_STAT_MIN_BORNED_CONST_H
